...
- **DTH IBAN yalnızca Bedel Yönetimi ekranında** (bedelin geldiği EUR/USD hesabı), **ACH IBAN yalnızca IBKB ekranında** (bozdurulan tutarın geçtiği TL hesabı) girilir.
